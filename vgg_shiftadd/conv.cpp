            	...
            	for (int l = 0; l < C5B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                        	...
                        	tmp_shift1 = (int)N[i+m][j+n][l];
                        	tmp_shift2 = (int)M[o*FILTER_SIZE*FILTER_SIZE*C6B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        	tmp += (tmp_shift1 >> tmp_shift2);
                            tmp += abs(N[i+m][j+n][l] - M[o*FILTER_SIZE*FILTER_SIZE*C6B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n]);
                        }       
                    }   
                } // end of one window , all input channels . output is written here, per pixel bias added
                P[(i/STRIDE_ALL)][(j/STRIDE_ALL)][o] =  tmp + B[o];
            	...
            	for (int l = 0; l < C6B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                        	...
                        	tmp_shift1 = (int)N[i+m][j+n][l];
							tmp_shift2 = (int)M[o*FILTER_SIZE*FILTER_SIZE*C6B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        	tmp += abs(N[i+m][j+n][l] - M[o*FILTER_SIZE*FILTER_SIZE*C7B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n]);
                        }       
                    }   
                } // end of one window , all input channels . output is written here, per pixel bias added
                P[(i/STRIDE_ALL)][(j/STRIDE_ALL)][o] =  tmp + B[o];
            	...
            	for (int l = 0; l < C7B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                        	...
                        	tmp_shift1 = (int)N[i+m][j+n][l];
							tmp_shift2 = (int)M[o*FILTER_SIZE*FILTER_SIZE*C6B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        	tmp += abs(N[i+m][j+n][l] - M[o*FILTER_SIZE*FILTER_SIZE*C8B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n]);
                        }       
                    }   
                } // end of one window , all input channels . output is written here, per pixel bias added
