            	...
            	for (int l = 0; l < C1B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                            ...
                            // actual multiply and add
                            tmp += local_padded[i+m][j+n][l] * M[o][m][n][l];
                        }       
                    }   
                } // end of one window , all input channels . output is written here, per pixel bias added
            	...
            	for (int l = 0; l < C3B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                            ...
                            // actual multiply and add
                            tmp += local_padded[i+m][j+n][l] * M[o*FILTER_SIZE*FILTER_SIZE*C3B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        }
                    }
                } // end of one window , all input channels . output is written here, per pixel bias added
                P[(i/STRIDE_ALL)][(j/STRIDE_ALL)][o] =  tmp;
            	...
            	for (int l = 0; l < C3B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                            ...
                            // actual multiply and add
                            tmp += N[i+m][j+n][l] * M[o*FILTER_SIZE*FILTER_SIZE*C4B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        }
                    }
                } // end of one window , all input channels . output is written here, per pixel bias added
                P[(i/STRIDE_ALL)][(j/STRIDE_ALL)][o] =  tmp;
            	...
            	for (int l = 0; l < C4B; l++){ // image channels
                    ...
                    for (int m = 0; m < FILTER_SIZE; m++){ // kernel rows
                        ...
                        for (int n = 0; n < FILTER_SIZE; n++){ // kernel columns
                            ...
                            // actual multiply and add
                            tmp += local_padded[i+m][j+n][l] * M[o*FILTER_SIZE*FILTER_SIZE*C4B + l*FILTER_SIZE*FILTER_SIZE + m*FILTER_SIZE + n];
                        }
                    }
                } // end of one window , all input channels . output is written here, per pixel bias added
                P[(i/STRIDE_ALL)][(j/STRIDE_ALL)][o] =  tmp;
