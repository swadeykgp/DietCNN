...
if __name__ == '__main__':
    ...
    pretrained_model = "./best_sig_model.pt"
    ...
    save_lut(c1_bias_lut, 'mnist_c1_bias_lut.txt')
    save_lut(c2_bias_lut, 'mnist_c2_bias_lut.txt')
    save_lut(f1_bias_lut, 'mnist_f1_bias_lut.txt')
    save_lut(f2_bias_lut, 'mnist_f2_bias_lut.txt')
