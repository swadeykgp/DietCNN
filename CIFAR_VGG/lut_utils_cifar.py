...
if __name__ == '__main__':
    ...
    save_index(filter_index_conv, 'cifar10_conv_flt.index')
    save_index(filter_index_fc, 'cifar10_fc_flt.index')
    save_lut(conv_lut, 'cifar10_conv_lut.txt')
    save_lut(fc_lut, 'cifar10_fc_lut.txt')
    save_lut(add_lut, 'cifar10_add_lut.txt')
    save_lut(c1_bias_lut, 'cifar10_c1_bias_lut.txt')
    save_lut(c2_bias_lut, 'cifar10_c2_bias_lut.txt')
    save_lut(c3_bias_lut, 'cifar10_c3_bias_lut.txt')
    save_lut(c4_bias_lut, 'cifar10_c4_bias_lut.txt')
    save_lut(c5_bias_lut, 'cifar10_c5_bias_lut.txt')
    save_lut(c6_bias_lut, 'cifar10_c6_bias_lut.txt')
    save_lut(c7_bias_lut, 'cifar10_c7_bias_lut.txt')
    save_lut(c8_bias_lut, 'cifar10_c8_bias_lut.txt')
    save_lut(f1_bias_lut, 'cifar10_f1_bias_lut.txt')
    save_lut(relu_lut, 'cifar10_relu_lut.txt')
